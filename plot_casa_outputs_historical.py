...
"""
CASA historical simulation diagnostics...
...
def plot_carbon_fluxes(cycle, ds, ds_cable):
    ...
    plot_fname = "%s_historical_carbon_fluxes_and_pools.pdf" % (cycle)
    plot_dir = "plots"
...
if __name__ == "__main__":
    ...
    #for cycle in ["C", "CN", "CNP"]:
        ...
        fname = "*_%s_out_cable_historical.nc" % (cycle)
        fname = glob.glob(os.path.join("outputs", fname))[0]
        ds_cable = open_cable_and_add_time(fname, start_date="01/01/1850")
